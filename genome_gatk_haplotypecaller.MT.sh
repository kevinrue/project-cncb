...
#SBATCH --job-name=gatk_haplotypecaller_MT
#SBATCH --output=genome_gatk_haplotypecaller_MT.%j.out
#SBATCH --error=genome_gatk_haplotypecaller_MT.%j.err
