...
#SBATCH --output=genome_gatk_haplotypecaller.%j.out
#SBATCH --error=genome_gatk_haplotypecaller.%j.err
...
# see <https://github.com/gatk-workflows/gatk4-germline-snps-indels/blob/master/haplotypecaller-gvcf-gatk4.wdl#L209>
 gatk HaplotypeCaller \
      ...
      -O genome_sequencing/aln-pe.rg.dedup.sorted.gvcf \
      -contamination 0 \
      -G StandardAnnotation -G StandardHCAnnotation -G AS_StandardAnnotation \
      -GQB 10 -GQB 20 -GQB 30 -GQB 40 -GQB 50 -GQB 60 -GQB 70 -GQB 80 -GQB 90 \
      -ERC GVCF \
      -bamout genome_sequencing/aln-pe.rg.dedup.sorted.bamout.bam
